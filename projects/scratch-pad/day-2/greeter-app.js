...
function greeter(hour) {
    ...
    //I:Hour aka number
    //O:A phrase greeting the user based on what time it is
    //C:
    //E:Case Sensitive
    //if the hour is between 0-11,
    if(hour < 12 && hour >= 0){
        //print "Good Morning"
        console.log("Good Morning!");
    }
    //if the hour is 12 or greater and less than or equal to 16
    ...
    //otherwise it's too late. Print goodnight
